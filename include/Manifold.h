...
public:
	...
	Manifold(Terrain *p_Terrain, Bomb *p_Rocket, std::vector<sf::Vector2f> p_CollisionNormals);

	Manifold(Soldier *p_SoldierOne, Soldier *p_SoldierTwo, std::vector<sf::Vector2f> p_CollisionNormals);
	Manifold(Soldier *p_Soldier, Bomb *p_Rocket, std::vector<sf::Vector2f> p_CollisionNormals);
};